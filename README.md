...
- [Kuzzle Angular NgRx](https://github.com/gpulido/kuzzle-ngrx): Ngrx Data and Entity wrapper over the Kuzzle JS sdk for Angular applications using [NgRx](https://ngrx.io/)
